...
$lang = array_merge($lang, array(
	...
	'MIGRATION_INVALID_DATA_MISSING_CONDITION'		=> 'Файл обновления содержит ошибки. Обработчик оператора ветвления не смог найти условие.',
	'MIGRATION_INVALID_DATA_MISSING_STEP'			=> 'Файл обновления содержит ошибки. Обработчик оператора ветвления не смог обнаружить корректный запуск шага обновления.',
	'MIGRATION_INVALID_DATA_CUSTOM_NOT_CALLABLE'	=> 'Файл обновления содержит ошибки. Настраиваемая вызываемая функция не может быть выполнена.',
	'MIGRATION_INVALID_DATA_UNKNOWN_TYPE'			=> 'Файл обновления содержит ошибки. Обнаружен неизвестный тип инструмента обновления.',
	'MIGRATION_INVALID_DATA_UNDEFINED_TOOL'			=> 'Файл обновления содержит ошибки. Обнаружен неизвестный инструмент обновления.',
	'MIGRATION_INVALID_DATA_UNDEFINED_METHOD'		=> 'Файл обновления содержит ошибки. Обнаружен неизвестный метод инструмента обновления.',
